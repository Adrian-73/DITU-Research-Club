...
<div class='nav' style='--sm:{$nav1-110}px; --lg : { $nav3 - 100 }% '>
        ...
        <div class =' py-6  h-full w-[180px] flex flex-col '>
            ...
            <a href="/Abouts" class='nav_item'>Abouts </a>
            <a href="/Gallary" class='nav_item'>Gallary</a>
            <a href="/Research" class='nav_item'>Research </a>
            <a href="/Form" class='nav_item'>Form </a>
        </div>
</div>
...
<div class="w-full sm:pt-0 pt-10 grid grid-cols-1 main place-items-center" style="--size : {$nav1+80 }px">
    <slot>
    </slot>
</div>
...
<footer class=' bg-stone-900 pt-20 p-[50px] pl-[100px] justify-center w-max sm:w-full'>
    <div class='px-4 justify-center w-full md:flex' >
        ...
        <div class='h-[560px] max-w-[490px] place-items-center justify-center'>
            <!-- svelte-ignore a11y-missing-attribute -->
            <div class="w-[260px] place-items-center grid"><img src={logo} class="mb-8 h-[190px]"/></div>
            <div class="flex w-[260px] justify-between pb-4">
