...
<nav class="nav" class:nav_2>
	<div
		class="max-w-full py-6 sm:bg-stone-400 rounded-r-full mr-10 sm:text-stone-400 text-lg origin-left scale-x-0 ease-in-out transition-all"
		class:nav_3
	>
		Menu
	</div>
	<ul
		class=" py-6 origin-left h-full w-full flex flex-col sm:opacity-0 sm:transition-all duration-500 ease-in-out"
		class:menu
	>
...
<header class="h-min w-full flex fixed top-0 left-0 place-self-center z-50">
	<button class=" menu_btn " on:click={nav}>
		<p class="transition-all ease-in-out duration-500" class:nav_4>Menu</p>
	</button>
	<div class="bg-stone-900 flex p-3 justify-start items-center w-full rounded-l-full sm:my-0 pl-6">
		<img
			class="h-[3.25rem]"
			src={dit}
			alt="View All Dit Dehradun - Dit University Dehradun Logo@seekpng.com"
		/>
		<p class="sm:text-4xl text-5xl  text-white pl-4">Research</p>
	</div>
</header>
<main
	class="w-full sm:pt-0 grid grid-cols-1 sm:pl-[70px] place-items-center ease-in-out duration-500"
	class:nav_1
>
	<slot />
</main>
...
<footer class=" bg-black pt-20 p-[50px] sm:pl-[100px] justify-center w-full sm:w-full">
	<div class="px-4 justify-center w-full md:flex mr-10">
		...
		<div class=" max-w-[490px] place-items-center justify-center">
			<div class="lg:w-full w-max ml-2 place-items-center grid">
				<a href="/"><img src={logo} alt="Research club logo" class="mb-8 h-[190px]" /></a>
			</div>
...
<style>
	...
	.nav {
		@apply bg-white w-full opacity-80 shadow-black sm:shadow-slate-500
